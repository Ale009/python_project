function loadGallery(users, onlyMine = false) {
    ...
    .then(res => res.json())
    .then(images => {
        //Accede a las imágenes y las recorre por cada una
        images.forEach(img => {
            ...
            // Si no existe el usuario, lo marcamos como desconocido
        ...
        //Hacemos que las imágenes sean "materialboxed" para que se vean más grandes al hacer click
